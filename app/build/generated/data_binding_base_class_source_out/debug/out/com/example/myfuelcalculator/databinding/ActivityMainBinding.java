...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView,
      @NonNull BottomAppBar bottomNavigation, @NonNull CoordinatorLayout coordinatorContainer,
      @NonNull FloatingActionButton fabCalculate, @NonNull ConstraintLayout mainContainer,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, bottomNavigation,
          coordinatorContainer, fabCalculate, mainContainer, navHostFragment);
    }
